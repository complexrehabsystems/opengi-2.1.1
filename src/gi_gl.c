						  ...
						  GIuint num_g_out, GIuint num_defines, ...)
{
	...
	GLenum uiType;
	GLchar *szName, *szName2, *szSource[2];
...
//		szName2 = (GIchar*)GI_MALLOC_ARRAY(iMaxLen, sizeof(GIchar));
//		for(i=0; i<iNum; ++i)
//		{
//			gl->_glGetActiveUniform(shader->program, i, iMaxLen, &iLength, &iSize, &uiType, szName2);
//			if(strncmp(szName2, "gl_", 3))
//			{
//				szName2[strcspn(szName2, "[")] = 0;
//				GIHash_insert(&shader->uniform_locs, szName2, 
//					(GIvoid*)(gl->_glGetUniformLocation(shader->program, szName2)+1));
//			}
////			printf("uniform: %s : %d\n", szName2, gl->_glGetUniformLocation(shader->program, szName2));
//		}
//    if (szName2) {
//      GI_FREE_ARRAY(szName2);
//      szName2 = NULL;
//    }
//	}
}
